...
\begin{tcolorbox}[colback=pBlue!10, colframe=pBlue, title=\textbf{The Output Engine}]
\textbf{Objective:} Calibrate vocal output for clarity and native-level signal transmission.
\end{tcolorbox}

...
\begin{tcolorbox}[colback=pBlue!10, colframe=pBlue, title=\textbf{The Selection Protocol}]
\textbf{Objective:} Define the specificity of variables (Nouns) in the system.
\end{tcolorbox}

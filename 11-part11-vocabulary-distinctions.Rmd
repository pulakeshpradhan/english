...
\begin{tcolorbox}[colback=pBlue!10, colframe=pBlue, title=\textbf{The Variable Definitions}]
\textbf{Objective:} Resolve conflicts between similar variables to prevent semantic errors.
\end{tcolorbox}
